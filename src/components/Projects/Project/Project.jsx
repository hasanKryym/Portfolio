...
const Project = ({ image, title, description, live_link, github_link }) => {
  const project_image = require(`../../../assets/images/projects/${image}`);
  return (
    <>
            ...
            <div className="card__links">
              {live_link && (
                <div>
                  ...
                  <a target="__blank" className="link" href={live_link}>
                    Preview
                  </a>
                </div>
              )}
              ...
              <div>
                ...
                <a target="__blank" className="link" href={github_link}>
                  Code
                </a>
              </div>
            </div>
